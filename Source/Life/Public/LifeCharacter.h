...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FLifeMovementModeChangedSignature, class ALifeCharacter*, Character, EMovementMode, PrevMovementMode, uint8, PreviousCustomMode);
...
class ALifeCharacter : public AGravityPawn
{
	GENERATED_BODY()
public:
...
public:
	...
	UPROPERTY(BlueprintAssignable, Category = Character)
		FLifeMovementModeChangedSignature MovementModeChangedDelegate;
